...
In contrast to a solid biopsy, a liquid biopsy is a non-invasive technique used to detect the presence of circulating tumor DNA (ctDNA). ctDNA originates from somatic mutations that occur in the tumor over the course of an individual's life unlike germline mutations that are present in all cells.
